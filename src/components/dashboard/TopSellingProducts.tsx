// src/components/dashboard/TopSellingProducts.tsx
import { BarChart, BarChart3, Loader2 } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
...
export function TopSellingProducts() {
  ...
  const { getTopSellingProducts, loading } = useDashboardData();
